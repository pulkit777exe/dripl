...
import type { RectangleElement, LinearElement, FreeDrawElement, TextElement, ImageElement, FrameElement } from '@dripl/common';
...
describe('store', () => {
  ...
  describe('actions', () => {
    ...
    it('should add linear element', () => {
      const element: LinearElement = {
        id: 'test-2', type: 'arrow',
        x: 0, y: 0, width: 100, height: 0,
        strokeColor: '#000',
        version: 1, versionNonce: 1, updated: Date.now(),
        roughness: 1, strokeStyle: 'solid', fillStyle: 'solid',
        seed: 0, angle: 0, locked: false, groupId: '', zIndex: 0,
        rotation: 0, flipHorizontal: 1, flipVertical: 1,
        points: [{ x: 0, y: 0 }, { x: 100, y: 0 }],
        labelId: '', containerId: '', text: '', fontSize: 16,
        fontFamily: 'Arial', lineHeight: 1.2, autoResize: false,
        padding: 0, title: '', arrowHeads: { start: false, end: true },
      };
      actions.addElement(element);
  ...
  describe('selectors', () => {
    it('should select elements', () => {
      const element: RectangleElement = {
        id: 'sel-1', type: 'rectangle', x: 0, y: 0, width: 10, height: 10,
        strokeColor: '#000', version: 1, versionNonce: 1, updated: Date.now(),
        roughness: 1, strokeStyle: 'solid', fillStyle: 'solid', seed: 0,
        angle: 0, locked: false, groupId: '', zIndex: 0, rotation: 0,
        flipHorizontal: 1, flipVertical: 1, points: [], labelId: '',
        containerId: '', text: '', fontSize: 16, fontFamily: 'Arial',
        lineHeight: 1.2, autoResize: false, padding: 0, title: '',
      };
      actions.addElement(element);
    ...
    it('should get element by id', () => {
      const element: RectangleElement = {
        id: 'get-1', type: 'rectangle', x: 0, y: 0, width: 10, height: 10,
        strokeColor: '#000', version: 1, versionNonce: 1, updated: Date.now(),
        roughness: 1, strokeStyle: 'solid', fillStyle: 'solid', seed: 0,
        angle: 0, locked: false, groupId: '', zIndex: 0, rotation: 0,
        flipHorizontal: 1, flipVertical: 1, points: [], labelId: '',
  ...
  describe('history', () => {
    it('should track undo/redo', () => {
      ...
      const element: RectangleElement = {
        id: 'hist-1', type: 'rectangle', x: 0, y: 0, width: 10, height: 10,
        strokeColor: '#000', version: 1, versionNonce: 1, updated: Date.now(),
        roughness: 1, strokeStyle: 'solid', fillStyle: 'solid', seed: 0,
        angle: 0, locked: false, groupId: '', zIndex: 0, rotation: 0,
        flipHorizontal: 1, flipVertical: 1, points: [], labelId: '',
