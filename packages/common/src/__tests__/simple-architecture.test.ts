...
describe("Dripl Architecture", () => {
  ...
  describe("Action System", () => {
    it("should create actions with valid types", () => {
      ...
      const updateAction = ActionCreator.updateElement(rect.id, {
        strokeColor: "#ff0000",
      });
  ...
  describe("Delta System", () => {
    it("should create and apply deltas", () => {
      ...
      deltaManager.createUpdateDelta(
        element.id,
        {},
        { strokeColor: "#ff0000" },
      );
    ...
    it("should revert deltas", () => {
      ...
      const finalScene = deltaManager.applyDeltas(
        scene,
        deltaManager.getDeltas(),
      );
      expect(finalScene.getElements()).toHaveLength(1);

      const originalScene = deltaManager.revertDeltas(
        finalScene,
        deltaManager.getDeltas(),
      );
