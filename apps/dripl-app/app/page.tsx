  ...
  return (
    <main className="min-h-dvh bg-[#f5f0e8] text-[#1a1a1a]">
      <div className="mx-auto max-w-5xl px-6 py-20">
        <p className="text-sm uppercase tracking-[0.2em] text-[#7a7267]">Dripl</p>
        ...
        <p className="mt-6 max-w-2xl text-lg text-[#5f584f]">
          Draw, share, and collaborate on an infinite canvas. Create a file, invite teammates, and
          keep everything synced live.
        </p>
