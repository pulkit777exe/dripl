...
import { User, Bell, Palette, Shield, CreditCard, Keyboard, ArrowLeft } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const currentSection = SETTINGS_SECTIONS[section] || SETTINGS_SECTIONS.profile;
    ...
    <div className="min-h-dvh flex">
      ...
      <aside className="w-64 border-r border-gray-800 p-4">
        ...
        <nav className="space-y-1">
          {Object.entries(SETTINGS_SECTIONS).map(([key, { icon: Icon, label }]) => (
            <Link
              key={key}
              href={`/settings/${key}`}
        ...
        <div className="max-w-2xl">
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
            <p className="text-gray-400">
              ...
              {section === 'notifications' && 'Notification preferences coming soon...'}
              ...
              {section === 'shortcuts' && 'Keyboard shortcut customization coming soon...'}
            </p>
          </div>
        </div>
      </main>
