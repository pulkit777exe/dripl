  ...
  return (
    <section className="container mx-auto px-4 py-32" id="pricing">
      <div className="mb-16 text-center">
        ...
        <p className="mb-10 text-lg text-foreground/60">No hidden fees. Cancel anytime.</p>
        ...
        {PLANS.map(plan => (
          <motion.div
            ...
            className={cn(
              ...
              plan.highlight && 'lg:-mt-4 lg:mb-4 lg:shadow-attio-md lg:border-deep-charcoal/10'
            )}
          >
            {plan.highlight && (
            ...
            <h3 className="text-xl font-medium text-deep-charcoal">{plan.name}</h3>
            ...
            <div className="my-8">
              <span className="text-5xl font-light tracking-tight text-deep-charcoal">
                {plan.price[billing] === 'Custom' ? 'Custom' : `$${plan.price[billing]}`}
              </span>
              {plan.price[billing] !== 'Custom' && <span className="text-foreground/40">/mo</span>}
            </div>
